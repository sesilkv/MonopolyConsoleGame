	...
	public class Board
	{
		...
		{			
			_tile = new List<Tile>
            {
                ...
                new Utility(6, "Electric Company", "Pay the amount $50", 50),
                new Chance(7, "Chance", "Please take a chance card"),
                new Tax(8, "Tax 1", "You should pay the tax $100", 100),
                ...
                new Utility(12, "Electric Company", "Pay the amount $50", 50),
                new Property(13, "Thailand", "Welcome to Thailand", 200, 70, 25, PropertyType.COUNTRY),
                new Tax(14, "Tax 1", "You should pay the tax $100", 100),
                ...
                new Utility(19, "Electric Company", "Pay the amount $50", 50),
                ...
                new Tax(25, "Tax 1", "You should pay the tax $100", 100),
