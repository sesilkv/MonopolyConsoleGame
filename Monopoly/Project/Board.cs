	...
	public class Board
	{
		...
		{			
			_tile = new List<Tile>
			{
				...
				new Property(1, "Indonesia", "Welcome to Indonesia", 200, 100, 50, PropertyType.Country),
				new CommunityChest(2, "Community Chest", "Please take a community card"),
				new Property(3, "Malaysia", "Welcome to Malaysia", 200, 100, 50, PropertyType.Country),
				// new Property(4, "Swiss", "Welcome to Swiss", 150, 50, 25, PropertyType.Country),
				// new Tax(4, "Tax", "Thank you for the payment", 100),
				...
				// new Utility(6, "Electric Company", "Thank you for the payment", 100),
				// new Jail(6, "In Jail", "Sorry, you must go to jail", 100),
				...
				new Property(13, "Thailand", "Welcome to Thailand", 200, 100, 50, PropertyType.Country),
				// new Tax(14, "Tax", "Thank you for the payment", 100),
				...
				new Property(16, "Japan", "Welcome to Japan", 300, 100, 50, PropertyType.Country),
				new CommunityChest(17, "Community Chest", "Please take a community card"),
				new Property(18, "Korea", "Welcome to Korea", 300, 100, 50, PropertyType.Country),
				...
				new Tax(25, "Tax", "Thank you for the payment", 100),
